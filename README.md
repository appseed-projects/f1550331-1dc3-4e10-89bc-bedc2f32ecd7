...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-12 09:30`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f1550331-1dc3-4e10-89bc-bedc2f32ecd7.git
$ cd f1550331-1dc3-4e10-89bc-bedc2f32ecd7
```
